...
class add_Test(TestMyUnit):
    def test_add_Test(self):
        ...
        # spglpage.click_new()
        # sleep(2)
        # spglpage.input_Name("123")
        # spglpage.input_Purchase(123)
        # spglpage.input_Sale(123)
        ...
        # sleep(3)
        # spglpage.input_pagination_editor(10, 0)
        # spglpage.click_data_modify(3)
        # sleep(2)
        # spglpage.input_Name("777", 1)
        # spglpage.input_Purchase(222, 1)
        # spglpage.input_Sale(333, 1)
